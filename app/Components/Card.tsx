...
const Card = ({blog}: CardProps) => {
  return (
    ...
    <div className="w-full flex justify-between ">
      <h3 className="text-2xl text-[#1F2937] font-bold truncate">{blog.title}</h3>
    ...
    <div className="flex gap-2 items-center justify-between">
      ...
      <div className="flex gap-2">
        <button className="borber border-[#E5E7EB] px-4 py-2"><Pencil color="#3B82F6" /></button>
        <button className="borber border-[#E5E7EB] px-4 py-2"><Trash2 color="#EF4444" /></button>
      </div>
    </div>
    <div className="flex gap-1.5 items-center justify-end ">
        <div className={`${blog.status === "public" ? "bg-[#10B981]" : "bg-[#F59E0B]"} size-1`} />
